...
template <>
struct ShaderSource<BuiltIn::GlobeShader, gfx::Backend::Type::OpenGL> {
    static constexpr const char* name = "GlobeShader";
...
void main() {
    ...
    static constexpr const char* fragment = R"(uniform sampler2D u_globe_image;
